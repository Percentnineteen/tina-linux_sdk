...
static int DecideStreamBufferSize(VideoDecoderContext* p)
{
    ...
    if(nPixels < BUFFER_SIZE_480P)
        nBufferSize = CdcGetConfigParamterInt("VIDEO_SBM_SIZE_480P", 2)*1024*1024;
    else if (nPixels < BUFFER_SIZE_720P)
        nBufferSize = CdcGetConfigParamterInt("VIDEO_SBM_SIZE_720P", 4)*1024*1024;
    else if(nPixels < BUFFER_SIZE_1080P)
        nBufferSize = CdcGetConfigParamterInt("VIDEO_SBM_SIZE_1080P", 6)*1024*1024;
    else if(nPixels < BUFFER_SIZE_2K)
        nBufferSize = CdcGetConfigParamterInt("VIDEO_SBM_SIZE_2K", 8)*1024*1024;
    else if(nPixels < BUFFER_SIZE_4K)
        nBufferSize = CdcGetConfigParamterInt("VIDEO_SBM_SIZE_4K", 16)*1024*1024;
    else
        nBufferSize =CdcGetConfigParamterInt("VIDEO_SBM_SIZE_MAX", 32)*1024*1024;
