...
int CdcIonFree(int fd, aw_ion_user_handle_t ion_handle)
{
    ...
    if(ret < 0)
    {
        //On linux5.4, 32bit system, arm platform, call loge(),change the value
        //of errno, causes the upper layer to call the old ion interface, the ion
        //fails to apply for memory.
